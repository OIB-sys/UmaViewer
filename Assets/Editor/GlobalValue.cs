...
public class GlobalValue : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        //Vector
        _Global_FogMinDistance = EditorGUILayout.Vector4Field("零賑竃・鉦宣", _Global_FogMinDistance);
        _Global_FogLength = EditorGUILayout.Vector4Field("零賑海業", _Global_FogLength);
        //Float
        _Global_MaxDensity = EditorGUILayout.Slider("恷詰嬬需業", _Global_MaxDensity, 0, 1);
        _Global_MaxHeight = EditorGUILayout.Slider("恷互辛需互業", _Global_MaxHeight, 0, 10);
        _GlobalOutlineOffset = EditorGUILayout.Slider("_GlobalOutlineOffset", _GlobalOutlineOffset, -100, 100);
        _GlobalOutlineWidth = EditorGUILayout.Slider("畠蕉態勢・錐業", _GlobalOutlineWidth, 0, 100);
        ...
        //Color
        _GlobalToonColor = EditorGUILayout.ColorField("咐唹冲弼", _GlobalToonColor);
        ...
        _GlobalRimColor = EditorGUILayout.ColorField("円垉高冲弼", _GlobalRimColor);
        ...
        //Vector Array
        _MainParam_0 = EditorGUILayout.Vector4Field("恣凛陶卞", _MainParam_0);
        _MainParam_1 = EditorGUILayout.Vector4Field("嘔凛陶卞", _MainParam_1);

        _HighParam1_0 = EditorGUILayout.Vector4Field("恣凛貧互高・w峙葎膿業・", _HighParam1_0);
        _HighParam1_1 = EditorGUILayout.Vector4Field("恣凛和互高", _HighParam1_1);
        _HighParam1_2 = EditorGUILayout.Vector4Field("褒凛描妨丼惚", _HighParam1_2);

        _HighParam2_0 = EditorGUILayout.Vector4Field("嘔凛貧互高", _HighParam2_0);
        _HighParam2_1 = EditorGUILayout.Vector4Field("嘔凛和互高", _HighParam2_1);
